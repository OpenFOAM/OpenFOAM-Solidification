...
Application
    solidificationFoam
Description
    Transient solver for columnar dendritic solidification of binary
    metal alloys according to Lever rule. There are two incompressible phases 
    (1 = solid, 2 = liquid). The phase densities may be different resulting in 
    ...
    modeled according to the Buossinesq approximation.
\*---------------------------------------------------------------------------*/
...
#include "BCs/robinTemperatureFvPatchScalarField.H"
